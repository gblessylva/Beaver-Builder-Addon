<?php
/**
 * Frontend template for Add Goal Module
 *
...
?>
<div class="hj-add-goal-form <?php echo esc_attr( $id ); ?>" data-redirect-url="<?php echo esc_attr( $settings->redirect_url ); ?>">
		...
		<form id="hj-goal-form" class="hj-goal-form">
			<div class="hj-main-content">
				...
				<div class="hj-priority-options">
					...
					<label class="hj-priority-option hj-selected">
						<input type="checkbox" name="focus_areas[]" value="pain" class="hj-priority-checkbox" checked>
